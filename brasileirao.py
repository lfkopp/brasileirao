...
short = pd.read_csv('brasileirao_2017.txt',sep=';', index_col=False)
...
plt.savefig('figs\short_final_2017.png')



long = pd.read_csv('brasileirao_long_2017.txt',sep=';', index_col=False, decimal=',')
...
plt.savefig('figs\long2_stacked_2017.png')
...
plt.savefig('figs\long2_2017.png')
...
plt.savefig('figs\long3_2017.png')
